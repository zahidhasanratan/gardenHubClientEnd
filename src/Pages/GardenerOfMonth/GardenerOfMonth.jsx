        ...
        <div className="bg-green-50 p-6 rounded-lg shadow-md flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-left">
            ...
            <p className="text-gray-700 text-sm">
              Monica turned her urban backyard into a thriving herbal sanctuary.
              She educates others on sustainable gardening and the benefits of
              native medicinal plants for health and wellness.
            </p>
          </div>
        </div>
      </div>
